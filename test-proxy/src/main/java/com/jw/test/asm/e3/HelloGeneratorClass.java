...
import com.jw.test.asm.e1.MyClassLoader;

public class HelloGeneratorClass implements Opcodes{
	private static String internalName = "com/jw/test/asm/e3/E3";
	private static String fullClassName = "com.jw.test.asm.e3.E3";
	/**
	...
	public static byte[] generatorHelloClass() throws Exception{
		...
		cw.visit(V1_7, ACC_PUBLIC + ACC_SUPER, internalName, null, "java/lang/Object", null);
...
//		}
	...
	public static void main3(String[] args){
		try{
			...
			File file = new File("/data/tmp/E3.class");
	...
	public static void main(String[] args){
		try{
			...
			AsmUtil.save("/data/tmp/E3.class", data);
			...
			Class<?> helloClass = myClassLoader.defineClass(fullClassName, data);
