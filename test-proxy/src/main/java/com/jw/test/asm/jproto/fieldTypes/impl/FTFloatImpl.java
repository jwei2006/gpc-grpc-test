...
public class FTFloatImpl implements IFieldType{
	private String fieldName = null;
	private String halfFieldName = null;
	private ClassWriter cw = null;
	
	public static FTFloatImpl getInstance(ClassWriter cw, String fieldName){
		return new FTFloatImpl(cw, fieldName);
	}
	
	public FTFloatImpl(ClassWriter cw, String fieldName){
		this.cw = cw;
