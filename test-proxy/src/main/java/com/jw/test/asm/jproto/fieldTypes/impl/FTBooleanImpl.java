...
public class FTBooleanImpl implements IFieldType{
	private String fieldName = null;
	private String halfFieldName = null;
	private ClassWriter cw = null;
	
	public static FTBooleanImpl getInstance(ClassWriter cw, String fieldName){
		return new FTBooleanImpl(cw, fieldName);
	}
	
	public FTBooleanImpl(ClassWriter cw, String fieldName){
		this.cw = cw;
