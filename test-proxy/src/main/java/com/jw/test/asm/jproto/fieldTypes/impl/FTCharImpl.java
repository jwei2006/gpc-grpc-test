...
public class FTCharImpl implements IFieldType{
	private String fieldName = null;
	private String halfFieldName = null;
	private ClassWriter cw = null;
	
	public static FTCharImpl getInstance(ClassWriter cw, String fieldName){
		return new FTCharImpl(cw, fieldName);
	}
	
	public FTCharImpl(ClassWriter cw, String fieldName){
		this.cw = cw;
