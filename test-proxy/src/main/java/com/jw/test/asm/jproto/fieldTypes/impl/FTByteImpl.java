...
public class FTByteImpl implements IFieldType{
	private String fieldName = null;
	private String halfFieldName = null;
	private ClassWriter cw = null;
	
	public static FTByteImpl getInstance(ClassWriter cw, String fieldName){
		return new FTByteImpl(cw, fieldName);
	}
	
	public FTByteImpl(ClassWriter cw, String fieldName){
		this.cw = cw;
