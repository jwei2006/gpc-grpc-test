...
public class FTDoubleImpl implements IFieldType{
	private String fieldName = null;
	private String halfFieldName = null;
	private ClassWriter cw = null;
	
	public static FTDoubleImpl getInstance(ClassWriter cw, String fieldName){
		return new FTDoubleImpl(cw, fieldName);
	}
	
	public FTDoubleImpl(ClassWriter cw, String fieldName){
		this.cw = cw;
