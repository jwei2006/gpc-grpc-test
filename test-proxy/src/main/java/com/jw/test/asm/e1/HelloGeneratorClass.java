...
public class HelloGeneratorClass implements Opcodes{
	...
	public static byte[] generatorHelloClass() throws Exception{
		...
		cw.visit(V1_7, ACC_PUBLIC + ACC_SUPER, "com/jw/test/asm/e1/Hello", null, "java/lang/Object", null);
		...
		}
		{
			...
			Label l5 = new Label();
			mv.visitLabel(l5);
			mv.visitFrame(Opcodes.F_FULL, 8, new Object[]{"com/jw/test/asm/e1/Hello", Opcodes.INTEGER, "[Ljava/util/Map;", "java/util/List",
			...
			mv.visitLabel(l2);
			mv.visitFrame(Opcodes.F_FULL, 4, new Object[]{"com/jw/test/asm/e1/Hello", Opcodes.INTEGER, "[Ljava/util/Map;", "java/util/List"},
			        0, new Object[]{});
			mv.visitFieldInsn(GETSTATIC, "java/lang/System", "out", "Ljava/io/PrintStream;");
			mv.visitTypeInsn(NEW, "java/lang/StringBuilder");
			mv.visitInsn(DUP);
	...
	public static void main(String[] args){
		try{
			...
			cr.accept(new AopClassAdapter(ASM4, cw), ClassReader.SKIP_DEBUG);

			data = cw.toByteArray();
			
			AsmUtil.save("Hello.class", data);

			MyClassLoader myClassLoader = new MyClassLoader();
			Class<?> helloClass = myClassLoader.defineClass("com.jw.test.asm.e1.Hello", data);
			...
			/*Class<?> stuClass = Thread.currentThread().getContextClassLoader().loadClass("com.jw.test.asm.e1.StudentServiceImpl");
